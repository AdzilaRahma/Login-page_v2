...
function ValidateLoginForm() {
   ...
   UsernameValidationMessage = isValidUsername(Username);
   if (UsernameValidationMessage != "valid") {
      ShowErrorMessage('Username', UsernameValidationMessage);
      return false;
   }
...
function RemoveAllErrorMessage() {
   ...
   let allErrorMessage = document.getElementsByClassName('error-message');
   let allErrorFiled = document.getElementsByClassName('error-input');
   let i;
...
function isValidUsername(username) {
   ...
   const minLength = 3;
   const maxLength = 13;
   const usernameRegex = /^[abcizABCZ][a-zA-Z0-9]{2,13}$/;
   ...
   if (username.length < minLength || username.length > maxLength) {
      return "Panjang karakter minimum 3 & maximum 13 karakter.";
   }

   if (!usernameRegex.test(username)) {
      return "Kode tidak valid, Isi sesuai kode voucher anda.";
   }
...
function isValidPassword(password) {
   ...
   const minLength = 3;
   const maxLength = 13;
   const passwordRegex = /^[abcizABCZ][a-zA-Z0-9]{2,13}$/;
...
let typed = new Typed(".auto-type", {
   strings: ["Bersifat Rahasia.", "Jangan Di Buang Sebelum Expired.", "Rusak Wajib Di Klaim Sebelum Expired."],
   typeSpeed: 115,
   backSpeed: 90,
   loop: true
